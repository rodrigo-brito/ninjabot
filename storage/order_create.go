...
func (oc *OrderCreate) check() error {
	if _, ok := oc.mutation.ExchangeID(); !ok {
		return &ValidationError{Name: "exchange_id", err: errors.New("storage: missing required field \"exchange_id\"")}
	}
	if _, ok := oc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New("storage: missing required field \"created_at\"")}
	}
	if _, ok := oc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New("storage: missing required field \"updated_at\"")}
	}
	if _, ok := oc.mutation.Symbol(); !ok {
		return &ValidationError{Name: "symbol", err: errors.New("storage: missing required field \"symbol\"")}
	}
	if _, ok := oc.mutation.Side(); !ok {
		return &ValidationError{Name: "side", err: errors.New("storage: missing required field \"side\"")}
	}
	if _, ok := oc.mutation.GetType(); !ok {
		return &ValidationError{Name: "type", err: errors.New("storage: missing required field \"type\"")}
	}
	if _, ok := oc.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New("storage: missing required field \"status\"")}
	}
	if _, ok := oc.mutation.Price(); !ok {
		return &ValidationError{Name: "price", err: errors.New("storage: missing required field \"price\"")}
	}
	if _, ok := oc.mutation.Quantity(); !ok {
		return &ValidationError{Name: "quantity", err: errors.New("storage: missing required field \"quantity\"")}
	}
	return nil
}
