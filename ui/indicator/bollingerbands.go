...
func BollingerBands(period int, stdDeviation float64, upDnBandColor, midBandColor string) ui.CustomIndicator {
...
func (bb bollingerBands) Metrics() []ui.IndicatorMetric {
